...
- Do not treat a custom item as production-ready while essential facts are missing. For a fabric shade, warn when its shape, colour, material, dimensions or fitting method is not confirmed. For a multi-light cluster, warn when the equal/staggered arrangement, individual drop lengths or overall height, and ceiling-plate form are not confirmed. For a table or other furniture item, warn when its principal dimensions and requested finish are not confirmed.
