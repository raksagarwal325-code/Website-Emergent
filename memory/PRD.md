...
- 2026-02-11: **Auto-pull cover — improved error handling & URL/handle normalization.**
  ...
  · Backend now differentiates: `private_or_deleted` only for genuine 404/410 responses ("appears deleted or URL is incorrect"), `no_thumbnail` for any other 4xx/5xx or missing `og:image` ("Instagram did not provide a cover image for this post — please upload manually"). No more misleading "private/deleted" messages for public posts.
