...
export default function CategorySwitchBar({ categories = [], activeSlug = null }) {
  ...
  return (
    <nav
      ...
      className="sticky top-20 z-40 -mx-6 mb-8 border-y border-white/10 bg-[#16070f]/97 px-6 py-3 backdrop-blur-md"
    >
      <div className="mx-auto max-w-7xl">
        <div className="mb-2 hidden items-center gap-3 md:flex">
          ...
          <span className="h-px flex-1 bg-gradient-to-r from-[#D4AF37]/28 to-transparent" aria-hidden="true" />
        </div>
