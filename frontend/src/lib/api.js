...
export const api = {
  ...
  adminProtectExistingImages: () => client.post("/image-protection/reprocess", {}).then(r => r.data),
  ...
  aiAnalyzeProductBatch: (items) =>
    client.post("/ai/analyze-product-batch", { items }).then(r => r.data),
  aiCommitProductBatch: (products) =>
