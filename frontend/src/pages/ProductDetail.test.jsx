...
describe("ProductDetail — live product photo request", () => {
  test("shows the current photo request on every product", async () => {
    ...
    expect(panel).toHaveTextContent("See a live view before ordering");
    expect(panel).toHaveTextContent("Request recent live photos");
    ...
    expect(message).not.toContain("share=whatsapp");
